...
public class LoginMae extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_mae2);
        ...
        entra.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(senha.getText().toString().equals("mae")){
                    openActivityCasa();
                }
                else{
                    Toast.makeText(LoginMae.this, "Senha incorreta", Toast.LENGTH_SHORT).show();
                }
            }
        });
