...
public class BanheiroPais extends AppCompatActivity {
    ...
    public void switcher(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (estado) {
                    image.setImageResource(R.drawable.banheiropaisapagado);
                    estado = false;
                } else {
                    image.setImageResource(R.drawable.banheiropaisaceso);
                    estado = true;
                }
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banheiro_pais);
