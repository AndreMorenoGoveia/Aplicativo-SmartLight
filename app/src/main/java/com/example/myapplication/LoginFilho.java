...
public class LoginFilho extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_filho);
        ...
        entra.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(senha.getText().toString().equals("filho")){
                    openActivityCasa();
                }
                else{
                    Toast.makeText(LoginFilho.this, "Senha incorreta", Toast.LENGTH_SHORT).show();
                }
            }
        });
