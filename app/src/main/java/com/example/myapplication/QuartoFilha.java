...
public class QuartoFilha extends AppCompatActivity {
    ...
    public void switcher(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (estado) {
                    image.setImageResource(R.drawable.quartofilhaapagado);
                    estado = false;
                } else {
                    image.setImageResource(R.drawable.quartofilhaaceso);
                    estado = true;
                }
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quarto_filha);
        ...
        button.setEnabled(mae || pai || filha);
