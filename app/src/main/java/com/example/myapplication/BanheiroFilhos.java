...
public class BanheiroFilhos extends AppCompatActivity {
    ...
    public void switcher(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (estado) {
                    image.setImageResource(R.drawable.banheirofilhosapagado);
                    estado = false;
                } else {
                    image.setImageResource(R.drawable.banheirofilhosaceso);
                    estado = true;
                }
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_banheiro_filhos);
